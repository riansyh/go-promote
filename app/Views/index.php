...
<body id="body">
    ...
    <div class="container">
        ...
        <div class="product">
            <div class="paket-satu frame-color">
                <h1 class="nama-paket">Bronze</h1>
                <h1>Rp.15.000</h1>
                <ul class="color-text-black">
                    <li>1 Day Keep</li>
                    <li>1x Feed</li>
                    <li>2x Instastory</li>
                </ul>
            ...
            <div class="paket-dua frame-color">
            ...
            <div class="paket-tiga frame-color">
            ...
            <div class="paket-empat frame-color">
